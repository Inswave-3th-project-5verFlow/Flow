...
public class DefVo extends com.demo.proworks.cmmn.ProworksCommVO {
    ...
    @ElDtoField(logicalName = "자동생성여부 ", physicalName = "autoGenerated", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "", attr = "")
    ...
    @ElVoField(physicalName = "autoGenerated")
    public String getAutoGenerated(){
        String ret = this.autoGenerated;
        return ret;
    }
    ...
    public String toString() {
        ...
        sb.append("autoGenerated").append("=").append(autoGenerated).append(",");
