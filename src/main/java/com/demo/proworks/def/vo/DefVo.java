...
public class DefVo extends com.demo.proworks.cmmn.ProworksCommVO {
    ...
    @ElDtoField(logicalName = "작성자id", physicalName = "assignee", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "", attr = "")
    ...
    @ElDtoField(logicalName = "최종 수정일시", physicalName = "updatedAt", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "", attr = "")
    ...
    @ElDtoField(logicalName = "검색 시작일", physicalName = "dateFrom", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "", attr = "")
